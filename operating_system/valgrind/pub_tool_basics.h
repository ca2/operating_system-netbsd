...
/* An abstraction of syscall return values.
   ...
   Solaris:
      ...
      When _isError == True,
         _val holds the error code.
*/
#if defined(VGP_mips32_netbsd) || defined(VGP_mips64_netbsd)
typedef
   struct {
      Bool  _isError;
      UWord _val;
   ...
   SysRes;
      ...
      && !defined(VGP_mips32_netbsd) && !defined(VGP_mips64_netbsd)
typedef
   struct {
      Bool  _isError;
      UWord _val;
...
static inline Bool sr_EQ ( UInt sysno, SysRes sr1, SysRes sr2 ) {
   /* This uglyness of hardcoding syscall numbers is necessary to
      ...
      include/vki/vki-scnums-mips{32,64}-netbsd.h.  It seems pretty
